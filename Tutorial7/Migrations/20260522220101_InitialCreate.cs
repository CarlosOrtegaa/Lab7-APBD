        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "NVD", new DateTime(1993, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "NVIDIA Corporation" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, new DateTime(2026, 3, 20, 10, 15, 0, 0, DateTimeKind.Unspecified), "Creator Workstation", 3, 48, 10.8m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CPU001", 1, 1, "High performance Intel processor", "Intel Core i7" },
                    { "CPU002", 2, 1, "High performance AMD processor", "AMD Ryzen 7" },
                    { "GPU001", 3, 2, "Dedicated graphics card for gaming and professional work", "NVIDIA RTX 4070" }
                });
